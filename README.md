...
* [Laravel Telescope](https://github.com/laravel/telescope) ⭐ 5,227 | 🐛 17 | 🌐 PHP | 📅 2026-09-09 - Laravel Telescope is an elegant debug assistant for the Laravel framework
...
* [Laravel Auditing](https://github.com/owen-it/laravel-auditing) ⭐ 3,463 | 🐛 13 | 🌐 PHP | 📅 2026-07-17 - Audit for Eloquent models
...
* [Intervention Image](https://github.com/Intervention/image) ⭐ 14,369 | 🐛 22 | 🌐 PHP | 📅 2026-08-29 - Image handling library for creating, editing and composing images
* [Laravel Excel](https://github.com/Maatwebsite/Laravel-Excel) ⭐ 12,703 | 🐛 1 | 🌐 PHP | 📅 2026-09-10 - Import and export Excel and CSV files
* [Laravel DOMPDF](https://github.com/barryvdh/laravel-dompdf) ⭐ 7,284 | 🐛 99 | 🌐 PHP | 📅 2026-07-09 - HTML to PDF generator using [dompdf](https://github.com/dompdf/dompdf) ⭐ 11,181 | 🐛 544 | 🌐 PHP | 📅 2026-08-02
* [Laravel MediaLibrary](https://github.com/spatie/laravel-medialibrary) ⭐ 6,163 | 🐛 1 | 🌐 PHP | 📅 2026-09-03 - Associate files with Eloquent models
...
* [LiveWire](https://github.com/livewire/livewire) ⭐ 23,575 | 🐛 16 | 🌐 PHP | 📅 2026-09-10 - A magical front-end framework for Laravel
...
* [Laravel OCI8](https://github.com/yajra/laravel-oci8) ⭐ 871 | 🐛 18 | 🌐 PHP | 📅 2026-09-09 - Oracle DB driver via OCI8
...
* [Envoy](https://github.com/laravel/envoy) ⭐ 1,615 | 🐛 3 | 🌐 PHP | 📅 2026-08-20 - SSH Task Runner
...
* [Language Files](https://github.com/caouecs/Laravel-lang) ⭐ 7,772 | 🐛 2 | 🌐 PHP | 📅 2026-09-10 - Validation, Pagination and Reminders language lines in 37 languages
...
* [LaraDock](https://github.com/LaraDock/laradock) ⭐ 12,675 | 🐛 21 | 🌐 Dockerfile | 📅 2026-09-10 - Run Laravel on Docker (Like Homestead but for Docker instead of Vagrant)
...
* [Monica](https://github.com/monicahq/monica) ⭐ 25,264 | 🐛 795 | 🌐 PHP | 📅 2026-04-24 - Personal relationship management system
* [Koel](https://github.com/phanan/koel) ⭐ 17,243 | 🐛 16 | 🌐 PHP | 📅 2026-09-09 - Personal music streaming server
* [Cachet](https://github.com/cachethq/Cachet) ⭐ 15,239 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Status page system for websites and APIs
* [Snipe-IT](https://github.com/snipe/snipe-it) ⭐ 14,927 | 🐛 935 | 🌐 PHP | 📅 2026-09-10 - IT asset/license management system
* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,117 | 🐛 14 | 🌐 PHP | 📅 2026-09-09 - Accounting software for small businesses and freelancers
* [Invoice Ninja](https://github.com/invoiceninja/invoiceninja) ⭐ 10,072 | 🐛 945 | 🌐 PHP | 📅 2026-09-11 - Invoicing, expenses, & time-tracking application
* [Pixelfed](https://github.com/pixelfed/pixelfed) ⭐ 7,097 | 🐛 116 | 🌐 PHP | 📅 2026-09-11 - A free and ethical photo sharing platform, powered by ActivityPub federation
* [Attendize](https://github.com/Attendize/Attendize) ⭐ 4,271 | 🐛 295 | 🌐 PHP | 📅 2024-08-20 - Ticket selling and event management platform
* [Canvas](https://github.com/cnvs/canvas) ⭐ 3,351 | 🐛 9 | 🌐 PHP | 📅 2026-09-08 - A Laravel Publishing Platform
...
* [OctoberCMS](https://github.com/octobercms/october) ⭐ 11,145 | 🐛 15 | 🌐 PHP | 📅 2026-09-10
...
* Want to suggest a package? Read the [Contribution Guide](https://github.com/chiraggude/awesome-laravel/blob/master/CONTRIBUTING.md) ⭐ 13,099 | 🐛 89 | 📅 2024-07-03
